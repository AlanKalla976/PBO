...
class FrmTranslator:
    ...
    def aturKomponen(self):
        ...
        Label(mainFrame, text='Bulgarian:').grid(row=2, column=0,
            sticky=W, padx=5, pady=5)
        Label(mainFrame, text='Arabic:').grid(row=3, column=0,
            sticky=W, padx=5, pady=5)
        Label(mainFrame, text='Myanmar:').grid(row=4, column=0,
            sticky=W, padx=5, pady=5)
    ...
    def onTranslate(self):
        ...
        # menterjemahkan
        hasil1 = penterjemah.translate(self.txtSumber.get(), src='id', dest='bg') 
        hasil2 = penterjemah.translate(self.txtSumber.get(), src='id', dest='ar') 
        hasil3 = penterjemah.translate(self.txtSumber.get(), src='id', dest='my') 
